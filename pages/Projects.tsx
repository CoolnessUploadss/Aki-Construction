        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {allProjectImages.map((img, idx) => (
              <div key={idx} className="group relative overflow-hidden rounded-xl shadow-lg h-[500px] bg-[#2a2c35]">
                <img 
                  src={img} 
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1a1c23] via-transparent to-transparent opacity-60 group-hover:opacity-90 transition-opacity pointer-events-none"></div>
                <div className="absolute bottom-0 left-0 p-8 translate-y-4 group-hover:translate-y-0 transition-transform pointer-events-none">
                  <h4 className="text-white font-heading font-black uppercase text-xl mb-1 tracking-wider">Aki Construction Work</h4>
                  <p className="text-[#ff6b35] font-bold uppercase text-xs tracking-[0.2em]">Quality Roofing Solution</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-20 text-center">
            <Link to="/" className="inline-flex items-center gap-3 border-2 border-[#1a1c23] text-[#1a1c23] px-10 py-4 font-heading font-black uppercase tracking-widest hover:bg-[#1a1c23] hover:text-white transition-all">
